...
function studentNav($href, $icon, $label) {
...
<aside class="w-64 h-screen bg-gradient-to-b from-blue-700 to-blue-900 flex flex-col shadow-xl fixed top-0 left-0 z-30 overflow-hidden">
  <div class="flex items-center gap-3 px-6 py-5 border-b border-blue-600">
    ...
    <div>
      ...
      <div class="text-blue-200 text-xs">Student Portal</div>
    </div>
  </div>
  <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
    <div class="px-4 py-1 text-xs font-semibold text-blue-300 uppercase tracking-widest mb-2">Main</div>
    <?= studentNav("$basePath/student/dashboard.php", 'fa-tachometer-alt', 'Dashboard') ?>
    <div class="px-4 py-1 text-xs font-semibold text-blue-300 uppercase tracking-widest mt-4 mb-2">Academics</div>
    <?= studentNav("$basePath/student/grades.php", 'fa-star', 'My Grades') ?>
    <?= studentNav("$basePath/student/history.php", 'fa-clock-rotate-left', 'Academic History') ?>
  </nav>
  <div class="px-4 py-4 border-t border-blue-600 shrink-0">
    <div class="flex items-center gap-3 mb-3">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="text-blue-300 text-xs">Student</div>
      </div>
    </div>
